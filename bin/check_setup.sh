...
echo "  nextflow run karlssoc/diann-wf -entry quantify_only -params-file configs/simple_quant.yaml -profile slurm"
echo ""
echo "  # Create library"
echo "  nextflow run karlssoc/diann-wf -entry create_library -params-file configs/library_creation.yaml -profile slurm"
echo ""
echo "  # Full pipeline"
